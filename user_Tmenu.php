...
<body>
	...
	<div class="navbar navbar-light bg-white d-block d-md-none">
		<div class="container-fluid">
			<a href="<?php echo "user_index.php?id=$id" ?>" class="navbar-brand d-block d-md-none"><span class="badge badge-primary px-3 pt-2"><h4 class="font-weight-bold">IT</h4></span><span class="ml-2 font-weight-bold text-secondary text-uppercase mt-2">ctc <span class="text-primary">network</span></span></a>
