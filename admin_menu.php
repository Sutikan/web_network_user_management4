...
<body>
	...
	<div class="nav flex-column mx-2" style="min-height: 100vh;">
		<a href="<?php echo "admin_index.php?id=$id" ?>" class="navbar-brand text-center mt-5"><span class="badge badge-primary px-3 pt-2"><h4 class="font-weight-bold">IT</h4></span><h5 class="font-weight-bold text-secondary text-uppercase mt-2">ctc <span class="text-primary">network</span></h5></a>
		<hr width="100%">
